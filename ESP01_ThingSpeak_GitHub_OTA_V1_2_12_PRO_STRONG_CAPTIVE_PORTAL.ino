...
String smartOutputCardHtml() {
  ...
  html += F("<div class='timergrid'><div><label class='small'>Hours</label><div class='tctrl'><button class='tbtn' type='button' onclick=\"adjTimer('th',1)\">▲</button><input id='th' type='number' min='0' max='23' step='1' name='th' value='"); html += String(th); html += F("'><button class='tbtn' type='button' onclick=\"adjTimer('th',-1)\">▼</button></div></div>");
  html += F("<div><label class='small'>Minutes</label><div class='tctrl'><button class='tbtn' type='button' onclick=\"adjTimer('tm',1)\">▲</button><input id='tm' type='number' min='0' max='59' step='1' name='tm' value='"); html += String(tm); html += F("'><button class='tbtn' type='button' onclick=\"adjTimer('tm',-1)\">▼</button></div></div>");
  html += F("<div><label class='small'>Seconds</label><div class='tctrl'><button class='tbtn' type='button' onclick=\"adjTimer('ts',1)\">▲</button><input id='ts' type='number' min='0' max='59' step='1' name='ts' value='"); html += String(ts); html += F("'><button class='tbtn' type='button' onclick=\"adjTimer('ts',-1)\">▼</button></div></div></div>");
