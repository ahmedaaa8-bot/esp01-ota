...
#define FW_VERSION         "1.2.31"
#define FW_BUILD           1231
#define FW_NAME            "Ahmed Monem Smart Control System "
#define FW_DEVICE_NAME     "Weather and Control "
#define FW_FULL_NAME       "ِAhmed Control System 00201004608852  . V1.2.31 "
...
// Web users / roles / permissions (V1.2.28 Egypt DST / Summer-Winter Time Fix)
...
#define EEPROM_CLOCK_MAGIC_ADDR  1120
#define EEPROM_CLOCK_EPOCH_ADDR  1124
...
#define EEPROM_TZ_MAGIC_ADDR     1132
#define EEPROM_TZ_MODE_ADDR      1133
...
void applySmartOutputControl() {
  ...
  if (scheduleOwnsOut3) {
    ...
    desired = isnan(currentTemperature) ? false : hysteresisDecision(currentTemperature, smartCfg.tempOnX10, smartCfg.tempOffX10, smartOutputState);
    ...
    desired = isnan(currentHumidity) ? false : hysteresisDecision(currentHumidity, smartCfg.humOnX10, smartCfg.humOffX10, smartOutputState);
